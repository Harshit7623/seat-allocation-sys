        ...
        <div className="mt-24 bg-white rounded-2xl shadow-xl p-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Import your student list and exam details</p>
            </div>
            <div className="text-center">
              <div className="bg-blue-600 text-white w-12 h-12 rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-4">
                2
              ...
              <p className="text-gray-600">Set up classroom layouts and constraints</p>
            </div>
            <div className="text-center">
              <div className="bg-blue-600 text-white w-12 h-12 rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-4">
                3
              ...
              <p className="text-gray-600">Get your seat allocation map instantly</p>
            </div>
          </div>
        </div>
      </div>
